...
3. Integration of our [trade flow data](https://github.com/ModelEarth/exiobase/blob/main/tradeflow/CLAUDE.md) to create AI training for predictive analysis and impact map details.